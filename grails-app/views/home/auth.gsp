...
<div class="well" style="width: 35%;margin:8% auto;border:4px solid #3573A3; ">
	...
	<g:link controller="home" action="interfaceAction"> <button class="btn btn-primary btn-lg"> Sign up </button></g:link>
